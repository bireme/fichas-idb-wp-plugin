...
<div class="header-banner">Recursos</div>
...
<div class="dem-container">
    <div class="left-column">
        <div class="indicator-circle">
            <img src="<?php echo plugin_dir_url(__FILE__) . 'images/icons/recursos.png'; ?>" alt="Recursos" class="dem-icon">
        </div>
        <div class="dem-label">Recursos</div>
