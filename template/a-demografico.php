...
<div class="header-banner">Demográfico</div>
...
<div class="dem-container">
    <div class="left-column">
        <div class="indicator-circle">
            <img src="<?php echo plugin_dir_url(__FILE__) . 'images/icons/demografico.png'; ?>" alt="DEM" class="dem-icon">
        </div>
        <div class="dem-label">Demográfico</div>
