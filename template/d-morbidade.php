...
<div class="header-banner">Morbidade</div>
...
<div class="dem-container">
    <div class="left-column">
        <div class="indicator-circle">
            <img src="<?php echo plugin_dir_url(__FILE__) . 'images/icons/morbidade.png'; ?>" alt="Morbidade" class="dem-icon">
        </div>
        <div class="dem-label">Morbidade</div>
