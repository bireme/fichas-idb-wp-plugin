...
<div class="header-banner">Fatores de Risco e Proteção</div>
...
<div class="dem-container">
    <div class="left-column">
        <div class="indicator-circle">
            <img src="<?php echo plugin_dir_url(__FILE__) . 'images/icons/fatores_de_risco.png'; ?>" alt="Fatores de Risco e Proteção" class="dem-icon">
        </div>
        <div class="dem-label">Fatores de Risco e Proteção</div>
