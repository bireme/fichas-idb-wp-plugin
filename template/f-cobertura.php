...
<div class="header-banner">Cobertura</div>
...
<div class="dem-container">
    <div class="left-column">
        <div class="indicator-circle">
            <img src="<?php echo plugin_dir_url(__FILE__) . 'images/icons/cobertura.png'; ?>" alt="Cobertura" class="dem-icon">
        </div>
        <div class="dem-label">Cobertura</div>
